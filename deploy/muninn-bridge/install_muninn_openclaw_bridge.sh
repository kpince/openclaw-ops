...
echo "[1/7] Installing muninn-bridge extension files"
mkdir -p "$EXT_DIR"
...
echo "[2/7] Installing systemd units/overrides"
...
echo "[3/7] Updating OpenClaw config"
...
echo "[5/7] Enabling and starting Muninn"
